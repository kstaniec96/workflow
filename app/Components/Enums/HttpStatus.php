...
namespace Simpler\Components\Enums;
...
final class HttpStatus
{
    ...
    /**
     * Get message base on http code.
     *
     * @param int $code
     * @return string
     */
    public static function message(int $code = self::OK): string
    {
        $status = [
        ...
        return $status[$code] ?? $status[self::OK];
    }
}
