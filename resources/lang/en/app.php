...
return [
    ...
    'You can join a maximum guide groups' => 'You can join a maximum of :groups default groups',
    ...
    'You can invite up to friends' => 'You can invite up to :friends friends',
    'You can join a maximum groups' => 'You can join a maximum :groups groups',
    'You can create up to groups' => 'You can create up to :groups groups',
    'The specified group name already exists' => 'The specified group name already exists',
];
